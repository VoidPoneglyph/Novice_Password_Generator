In the above python code, we use Twitter API keys to access tweets from specific twitter handles. In this case, we're extracting tweets from the official Bill Gates twitter handle.
